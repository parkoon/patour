...
parcelRequire = (function(modules, cache, entry, globalName) {
...
})(
  {
    ...
    'login.js': [
                  ...
                  while (1) {
                    switch ((_context.prev = _context.next)) {
                      ...
                      case 8:
                        ...
                        console.log(_context.t0); // alert(err.response.data.message);
      ...
      { axios: '../../node_modules/axios/index.js', './alerts.js': 'alerts.js' }
    ],
    'mapbox.js': [
      function(require, module, exports) {
        'use strict';
    ...
    'stripe.js': [
      function(require, module, exports) {
        ...
        var stripe = Stripe('pk_test_EzxXLK1WfUL5p5V0pD0lV1af00y7mGFrMM');
                  ...
                  while (1) {
                    switch ((_context.prev = _context.next)) {
                      case 0:
                        ...
                        _context.next = 3;
                        return (0, _axios.default)(
                          'http://localhost:4000/api/v1/bookings/checkout-session/'.concat(
                            tourId
                          )
                        );
                      ...
                      switch ((_context.prev = _context.next)) {
                        case 0:
                          ...
                          passwordConfirm = document.getElementById(
                            'password-confirm'
                          ).value; // async 함수기 때문에 await을 쓸 수 있음!
